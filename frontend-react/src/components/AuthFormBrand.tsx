/** Logo + colorful "JanSarthi AI" wordmark shown above the login/signup card, centered on one
 ...
 *
 * Colored to match the source logo's own wordmark (navy "Jan" / green "Sarthi" / blue "AI")
  ...
  return (
    <div className="auth-form-brand">
      ...
      <div className="auth-form-brand-word display">
        ...
        <span className="auth-form-brand-mitra">Sarthi</span> <span className="auth-form-brand-ai">AI</span>
      </div>
    </div>
  );
}
